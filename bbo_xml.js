	...
	var xmlDoc = parser.parseFromString(document.body.innerHTML,"text/xml");
	var evNode = xmlDoc.getElementsByTagName("EVENT")[0];
	
	var txt = getAttribute(evNode,"EVENT_TYPE");
	alert(txt);
	
	var sectionNodes = evNode.getElementsByTagName("SECTION");
	
	for (var i=0;i<sectionNodes.length;i++)
	{
		var sectionrec = sectionNodes[i];
		var sectionLetter = getAttribute(sectionrec,"SECTION_ID");
